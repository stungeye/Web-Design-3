...
<Note>
  Good layout starts before CSS. Clear semantic structure helps scaffold your
  design work.
</Note>
...
5. organize your CSS
6. add responsive fluidity
7. test the site
8. deploy!

## SNEAK PEEK: Assignment 1
...
## Our Simplified A1 And A2 Build Process
...
1. Build semantic markup.
2. Style readable defaults.
3. Craft intentional layout.
4. Test the site.
...
- `<a>` uses plain language to say where it links
...
<Practice>
  If all CSS were removed from a page would it still read in a logical order.
</Practice>

## Page Skeleton

Many small pages have a familiar structure:
...
<Note>
A page should usually have only one `<main>` element, a landmark for the content unique to that page.
</Note>
...
<Warning>Headings should not skip levels for visual effect.</Warning>
...
Once the page skeleton is clear, choose elements that match specific content.
...
```html
Primary link:
<a href="http://glutton-farm.ca">Visit our Bountiful Arceage </a>

Secondary link:
<a href="http://glutton-farm.ca" class="secondary"
  >Visit our Bountiful Archeage</a
>

Link as button:
<a href="http://glutton-farm.ca" class="button">Visit our Bountiful Arceage</a>
```

<Practice>Use and style native elements. Add classes for variants.</Practice>
...
Let's look more closely at the first assignment!
...
<Question>
  If all CSS failed to load, would the page still make sense? Would the page
  survive [CSS Naked Day](https://css-naked-day.org/)?
</Question>
