...
describe("LineHeightDemo", () => {
  it("renders choices, preview text, and generated CSS", () => {
    ...
    expect(screen.getByLabelText("line-height: 1.2")).toBeChecked();
    expect(screen.getByLabelText("line-height: 1.5")).toBeInTheDocument();
    ...
    expect(getCodeBlockContaining("line-height: 1.2;")).toBeInTheDocument();
    expect(container.querySelector("[data-line-height-preview]")).toHaveStyle({
      "--line-height-demo-value": "1.2",
    });
  });
});
